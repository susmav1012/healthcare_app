...
public class Database extends SQLiteOpenHelper {
    ...
    public int login(String username,String password)
    {
        ...
        if (c.moveToFirst())//if there is any record in db
        {
            result = 1;
        }
        //db.close();
...
//    public int checkLogin(String username,String email,String password){
//        int result=0;
...
//
//        SQLiteDatabase db=getReadableDatabase();
//        Cursor c=db.rawQuery("select * from cart where username=? and email=? and password=?",str);
//        if (c.moveToFirst())//if there is any record in db
//        {
//            result = 1;
//        }
